...
/// ATW-8: toolbar operator chip. Opens an agent picker and calls `setOperator`. Replaces
/// the legacy `PersonaPicker`/persona-editor flow (ATW-8 requirement 7).
struct OperatorChip: View {
