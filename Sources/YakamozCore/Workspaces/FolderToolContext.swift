...
/// `ToolOrigin.workspace(id:name:)` stays stable across tool refreshes — mirroring
/// `TerminalToolContext.workspaceId` for terminal workspaces (PKPOST-004c: origin is
